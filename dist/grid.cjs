(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(mod.exports, global.ansi, global.color);
    global.grid = mod.exports;
  }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _ansi, _color) {
  "use strict";
   ...
   */
  const Grid = function (str, opts) {
    const options = opts || {};
    this.ansi = new _ansi.Ansi(options.color || new _color.Color(options.bitDepth) || new _color.Color('4bit'));
  ...
  Grid.prototype.setValue = function (x, y, chr, styles, postStyles) {
    ...
    if (styles === true) {
      value.styles = this.data[y][x] && this.data[y][x].styles ? this.data[y][x].styles.concat(value.styles) : value.styles ? value.styles : [];
    }
  ...
  Grid.prototype.drawOnto = function (str, offX, offY, isTransparent, mergeStyles) {
    if (offX < 0 || offY < 0) {
      //negatives for positioning from opposite margin
