(function (root, factory){
    if(typeof define === 'function' && define.amd){
        ...
        root.Ascii.AnsiTools.Grid = factory(root.Ascii.AnsiTools.Ansi);
    }
}(this, function(Ansi){
    /**
     ...
     */
    var Canvas = function(str, opts){
        const options = opts || {};
        this.ansi = new Ansi(options.bitDepth || '4bit');
     ...
     * @param {array} styles
     */
    Canvas.prototype.setValue = function(x, y, chr, styles){
